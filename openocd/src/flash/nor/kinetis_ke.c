...
int kinetis_ke_stop_watchdog(struct target *target)
{
	...
	static const uint8_t watchdog_code[] = {
		0x09,0x4B,	/* ldr	r3, .L2			*/
		0x7F,0x22,	/* mov	r2, #127		*/
		0x1D,0x78,	/* ldrb	r5, [r3]		*/
		0x5C,0x78,	/* ldrb	r4, [r3, #1]	*/
		0x2A,0x40,	/* and	r2, r5			*/
		0x08,0x4D,	/* ldr	r5, .L2+4		*/
		0x98,0x88,	/* ldrh	r0, [r3, #4]	*/
		0xD9,0x88,	/* ldrh	r1, [r3, #6]	*/
		0x5D,0x80,	/* strh	r5, [r3, #2]	*/
		0x07,0x4D,	/* ldr	r5, .L2+8		*/
		0xE4,0xB2,	/* uxtb	r4, r4			*/
		0x80,0xB2,	/* uxth	r0, r0			*/
		0x89,0xB2,	/* uxth	r1, r1			*/
		0x5D,0x80,	/* strh	r5, [r3, #2]	*/
		0x5C,0x70,	/* strb	r4, [r3, #1]	*/
		0x98,0x80,	/* strh	r0, [r3, #4]	*/
		0xD9,0x80,	/* strh	r1, [r3, #6]	*/
	...
	if (retval != ERROR_OK) {
		LOG_ERROR("Error executing kinetis ke Flash programming algorithm");
...
static uint8_t kinetis_ke_flash_write_code[] = {
	...
	/* Params:
	 * r0 - workarea (RAM buffer)
	 * r1 - address (target address)
	 * r2 - words (longwords count)
	 */

	/* Cycle the buffer while writing long words (32bit).
	 * No checks are done here, words2 must be exactly (bytes to write * 4),
	 * and address must be already aligned.
	 * Optimize me!
	 */
					/* .L1:				*/
	0x00, 0x2A,		/* cmp r2, #0 		*/
	...
	0x25, 0x4B,		/* ldr r3, .L5+4	*/
	0x00, 0x24,		/* mov r4, #0		*/
	0x1C, 0x70,		/* strb r4, [r3]	*/
	0x24, 0x4B,		/* ldr r3, .L5+8	*/
	0x06, 0x24,		/* mov r4, #6		*/
	0x1C, 0x70,		/* strb r4, [r3]	*/
	0x0C, 0x0C,		/* lsr r4, r1, #16	*/
	0x23, 0x4B,		/* ldr r3, .L5+12	*/
	0x1C, 0x70,		/* strb r4, [r3]	*/
	0x20, 0x4B,		/* ldr r3, .L5+4	*/
	0x01, 0x24,		/* mov r4, #1		*/
	0x1C, 0x70,		/* strb r4, [r3]	*/
	0xCC, 0xB2,		/* uxtb r4, r1		*/
	0x20, 0x4B,		/* ldr r3, .L5+12	*/
	0x1C, 0x70,		/* strb r4, [r3]	*/
	0x0C, 0x0A,		/* lsr r4, r1, #8	*/
	0x1E, 0x4B,		/* ldr r3, .L5+8	*/
	0x1C, 0x70,		/* strb r4, [r3]	*/
	0x1C, 0x4B,		/* ldr r3, .L5+4	*/
	0x02, 0x24,		/* mov r4, #2		*/
	0x1C, 0x70,		/* strb r4, [r3]	*/
	0x44, 0x78,		/* ldrb r4, [r0, #1]*/
	0x1B, 0x4B,		/* ldr r3, .L5+8	*/
	0x1C, 0x70,		/* strb r4, [r3]	*/
	0x04, 0x78,		/* ldrb r4, [r0]	*/
	0x1A, 0x4B,		/* ldr r3, .L5+12	*/
	0x1C, 0x70,		/* strb r4, [r3]	*/
	0x17, 0x4B,		/* ldr r3, .L5+4	*/
	0x03, 0x24,		/* mov r4, #3		*/
	0x1C, 0x70,		/* strb r4, [r3]	*/
	0xC4, 0x78,		/* ldrb r4, [r0, #3]*/
	0x16, 0x4B,		/* ldr r3, .L5+8	*/
	0x1C, 0x70,		/* strb r4, [r3]	*/
	0x84, 0x78,		/* ldrb r4, [r0, #2]*/
	0x16, 0x4B,		/* ldr r3, .L5+12	*/
	0x1C, 0x70,		/* strb r4, [r3]	*/
	0x04, 0x30,		/* add r0, r0, #4	*/
	0x04, 0x31,		/* add r1, r1, #4	*/
	0x01, 0x3A,		/* sub r2, r2, #1	*/
	0x01, 0x2A,		/* cmp r2, #1		*/
	0x14, 0xD9,		/* bls .L2			*/
	0x10, 0x4B,		/* ldr r3, .L5+4	*/
	0x04, 0x24,		/* mov r4, #4		*/
	0x1C, 0x70,		/* strb r4, [r3]	*/
	0x44, 0x78,		/* ldrb r4, [r0, #1]*/
	0x0F, 0x4B,		/* ldr r3, .L5+8	*/
	0x1C, 0x70,		/* strb r4, [r3]	*/
	0x04, 0x78,		/* ldrb r4, [r0]	*/
	0x0F, 0x4B,		/* ldr r3, .L5+12	*/
	0x1C, 0x70,		/* strb r4, [r3]	*/
	0x0C, 0x4B,		/* ldr r3, .L5+4	*/
	0x05, 0x24,		/* mov r4, #5		*/
	0x1C, 0x70,		/* strb r4, [r3]	*/
	0xC4, 0x78,		/* ldrb r4, [r0, #3]*/
	0x0B, 0x4B,		/* ldr r3, .L5+8	*/
	0x1C, 0x70,		/* strb r4, [r3]	*/
	0x84, 0x78,		/* ldrb r4, [r0, #2]*/
	0x0A, 0x4B,		/* ldr r3, .L5+12	*/
	0x1C, 0x70,		/* strb r4, [r3]	*/
	0x04, 0x30,		/* add r0, r0, #4	*/
	0x04, 0x31,		/* add r1, r1, #4	*/
	0x01, 0x3A,		/* sub r2, r2, #1	*/
					/* .L2:				*/
	0x05, 0x4B,		/* ldr r3, .L5		*/
	0x80, 0x24,		/* mov r4, #128		*/
	0x1C, 0x70,		/* strb r4, [r3]	*/
					/* .L3:				*/
	0x03, 0x4B,		/* ldr r3, .L5		*/
	0x1B, 0x78,		/* ldrb r3, [r3]	*/
	0x5B, 0xB2,		/* sxtb r3, r3		*/
	0x00, 0x2B,		/* cmp r3, #0		*/
	0xFA, 0xDA,		/* bge .L3			*/
	0xB3, 0xE7,		/* b .L1			*/
					/* .L4: 			*/
	...
	/* Placeholder for FTMRx registers */
	0x00, 0x00, 0x00, 0x00,		/* FSTAT	*/
	0x00, 0x00, 0x00, 0x00,		/* FCCOBIX	*/
	0x00, 0x00, 0x00, 0x00,		/* FCCOBHI	*/
	0x00, 0x00, 0x00, 0x00,		/* FCCOBLO	*/
};
									...
									uint32_t offset, uint32_t count)
{
	...
	while (count)
	{
		if (count > ram_buffer_size)
		{
			write = ram_buffer_size;
		} else {
			write = count;
		}
		...
		{
			uint8_t idx = 0;
			memset(last_word, 0xFF, 4);
			while (idx < write)
			{
				last_word[idx] = buffer[idx];
				idx++;
			}

			buf_set_u32(reg_params[2].value, 0, 32, 1);
			retval = target_write_buffer(target, source->address, 4, last_word);

		} else {

			buf_set_u32(reg_params[2].value, 0, 32, write / 4);
			retval = target_write_buffer(target, source->address, write, buffer);
		}

		if (retval != ERROR_OK)
		{
			LOG_ERROR("Error writing block to kinetis ke RAM.");
			retval = ERROR_FLASH_OPERATION_FAILED;
			break;
		} else {
			 ...
			 uint32_t offset, uint32_t count)
{
	...
	return kinetis_ke_write_words(bank, buffer, offset, count);
}

static int kinetis_ke_read_part_info(struct flash_bank *bank)
{
	int result, i;
	uint32_t offset = 0;
	struct target *target = bank->target;
